...
public class CompanyRepositoryTest extends IntegrationTestSuite {
  ...
  public void createSimple() throws Exception {
    ...
    System.out.println(companies.get(0).getE_mails());
    System.out.println(companies.get(0).getZip());

    companyRepository.create(companies.get(0));
    Company company = companyRepository.findCompany(companies.get(0).getName());
    System.out.println(company.getName());
    System.out.println(company.getCity());
    System.out.println(company.getE_mails());
  ...
  public void create100() throws Exception {
    ...
    for (Company company : companies) {
      Company dbCompany = companyRepository.findCompany(company.getName());
  ...
  public void zip2city() throws Exception {
    ...
    Company company = companyRepository.findCompany(companies.get(0).getName());
    Assert.assertEquals(companies.get(0), company);
    Company company2 = companyRepository.findCompany(companies.get(1).getName());
  ...
  public void findFail() throws Exception {
    List<Company> companies = generateCompany(100);
    companyRepository.create(companies.get(0));
    companyRepository.findCompany("NotExist");
  }
  ...
  public void delete() throws Exception {
    ...
    companyRepository.findCompany(companies.get(0).getName());
  }
